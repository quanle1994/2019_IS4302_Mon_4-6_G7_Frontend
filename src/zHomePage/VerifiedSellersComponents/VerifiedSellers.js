...
class VerifiedSellers extends React.Component {
  componentWillMount() {
...
export default compose(withStyles(style), connect(mapStateToProps, mapDispatchToProps))(VerifiedSellers);

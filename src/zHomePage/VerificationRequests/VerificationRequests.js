...
class VerificationRequests extends React.Component {
  componentWillMount() {
    ...
    this.setState({}, () => dispatch({
      ...
      currentPage: 'verification_requests',
      products: [],
    }));
...
export default compose(withStyles(style), connect(mapStateToProps, mapDispatchToProps))(VerificationRequests);
